...
chinese_datasets = ['THUCNews', 'local-news-zh', 'local-webnovel', 'local-wiki-zh']
...
class PrefixSampler:
    ...
    def _sample_from_model(self, texts, min_words=55, truncate_ratio=0.5):
        ...
        elif self.args.dataset in chinese_datasets:
        ...
        if self.args.dataset in chinese_datasets:
    ...
    def generate_samples(self, raw_data, batch_size):
        ...
        def _trim_to_shorter_length(texta, textb):
            ...
            if args.dataset in chinese_datasets:
